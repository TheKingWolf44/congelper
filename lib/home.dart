...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  String titleMess = message.notification?.title ?? '';
  await saveNotification('BACKGROUND $titleMess');
...
// print('User granted permission: ${settings.authorizationStatus}');
    return MaterialApp(
      ...
      home: const HomePage(title: 'Congelper'),
    );
  }
}
